...
#
# zynq_psdma.tcl: Tcl script for re-creating project 'zynq_psdma'
#
# Generated by Vivado on Sun Jan 15 23:35:21 +0300 2023
...
#
# 1. This project restoration tcl script (zynq_psdma.tcl) that was generated.
#
...
set _xil_proj_name_ "zynq_psdma"
...
set script_file "zynq_psdma.tcl"
...
Reset#SD 0#UART 1#UART 1#GPIO#GPIO#GPIO#GPIO}\
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.773913",
   "Default View_TopLeft":"-40,0",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:10.0 non-TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 5 -x 1230 -y 250 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 5 -x 1230 -y 280 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 200 -y 310 -defaultsOSRD
preplace inst axi_bram_ctrl_0 -pg 1 -lvl 3 -x 830 -y 380 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 2 -x 560 -y 360 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -x 200 -y 100 -defaultsOSRD
preplace inst axi_bram_ctrl_0_bram -pg 1 -lvl 4 -x 1090 -y 380 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 -20 450 430 450 690
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 -10 440 410
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 420 440 700J
preplace netloc processing_system7_0_DDR 1 1 4 430J 250 NJ 250 NJ 250 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 4 NJ 280 NJ 280 NJ 280 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 N 340
preplace netloc axi_smc_M00_AXI 1 2 1 N 360
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 3 1 NJ 380
levelinfo -pg 1 -40 200 560 830 1090 1230
pagesize -pg 1 -db -bbox -sgen -40 0 1340 580
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse system.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/zynq_psdma.gen/sources_1/bd/system/hdl/system_wrapper.vhd" ]
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/zynq_psdma.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/zynq_psdma.srcs/utils_1/imports/impl_1" -objects $obj
